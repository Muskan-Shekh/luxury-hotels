...
const create_data = async (payment_status) => {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            {showModal == "stripe" && res_data && <Elements stripe={stripePromise}> <CheckoutModal response_data={res_data} stripePromise={stripePromise} setShowModal={setShowModal} amount={totalAmount} payment_method={watch("payment_method")} detils_data={data} purpose="nomination" time={6} create_function={create_data} redirect={"/dashboard/hotel-info"} /></Elements>}
        </div>
    );
}
