...
const HotelPreview = () => {
    ...
    const previewImages = hotel_details_fetch?.google_photos ? hotel_details_fetch?.google_photos.slice(0, 6) : "";

    // Get remaining images
    const remainingImages = hotel_details_fetch?.google_photos;
    ...
    const getYouTubeEmbedURL = (url) => {
      ...
      console.log("videoUrl", videoUrl,hotel_details_fetch?.youtube)
